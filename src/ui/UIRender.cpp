...
static GLint uLocProjMat = 0;

// attrib Locations
static GLint aLocPosition = 0;
static GLint aLocUV = 0;
static GLint aLocColor = 0;

static GLuint vboID = 0;
static GLuint vaoID = 0;
static GLuint eboID = 0;
...
bool ImGui_ImplSdlGL3_CreateDeviceObjects()
{
    ...
    glBindVertexArray(vaoID);
    glBindBuffer(GL_ARRAY_BUFFER, vboID);
    glEnableVertexAttribArray(aLocPosition);
    glEnableVertexAttribArray(aLocUV);
    glEnableVertexAttribArray(aLocColor);

    glVertexAttribPointer(aLocPosition, 2, GL_FLOAT, GL_FALSE, sizeof(ImDrawVert), (GLvoid*)IM_OFFSETOF(ImDrawVert, pos));
    glVertexAttribPointer(aLocUV, 2, GL_FLOAT, GL_FALSE, sizeof(ImDrawVert), (GLvoid*)IM_OFFSETOF(ImDrawVert, uv));
    glVertexAttribPointer(aLocColor, 4, GL_UNSIGNED_BYTE, GL_TRUE, sizeof(ImDrawVert), (GLvoid*)IM_OFFSETOF(ImDrawVert, col));
